...
<div class="widget stay-on-collapse" id="widget-sidebar">
    ...
    <nav role="navigation" class="widget-body">
        <ul class="acc-menu">            
            <li><a href="javascript:;"><i class="fa fa-columns"></i><span>Layouts</span><span class="badge badge-info">23</span></a>
                <ul class="acc-menu">
                    ...
                    <li><a href="javascript:;">Horizontal Nav <span class="badge badge-info">2</span></a>
                        <ul class="acc-menu">
            ...
            <li><a href="javascript:;"><i class="fa fa-flask"></i><span>Base UI</span><span class="badge badge-info">99</span></a>
                <ul class="acc-menu">
            ...
            <li><a href="javascript:;"><i class="fa fa-random"></i><span>Custom Components</span><span class="badge badge-info">99</span></a>
                <ul class="acc-menu">
            ...
            <li><a href="javascript:;"><i class="fa fa-pencil"></i><span>Advanced Forms</span><span class="badge badge-info">99</span></a>
                <ul class="acc-menu">
            ...
            <li><a href="javascript:;"><i class="fa fa-table"></i><span>Advanced Tables</span><span class="badge badge-info">99</span></a>
                <ul class="acc-menu">
...
<!--		<li><a href="javascript:;"><i class="fa fa-briefcase"></i><span>Extras</span><span class="badge badge-info">99</span></a>
                    <ul class="acc-menu">
            ...
            <li><a href="javascript:;"><i class="fa fa-sitemap"></i><span>Multiple Level Menu</span><span class="badge badge-info">99</span></a>
                    <ul class="acc-menu">
